    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', tinymce.models.HTMLField(blank=True, verbose_name='商品详情')),
            ],
            options={
                'verbose_name': '商品SPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=5, max_digits=10, max_length=256, verbose_name='商品价格')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Goods.goodssku', verbose_name='商品SKU')),
                ('goods_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Goods.goodstype', verbose_name='商品种类')),
            ],
            options={
                'verbose_name': '分类商品展示',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Goods.goodssku', verbose_name='商品')),
            ],
            options={
                'verbose_name': '商品图片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Goods.goodssku', verbose_name='商品')),
            ],
            options={
                'verbose_name': '首页轮播商品',
