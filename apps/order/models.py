...
class OrderInfo(BaseModel):
    ...
    user = models.ForeignKey('Users.User', verbose_name='用户', on_delete=models.DO_NOTHING)
    addr = models.ForeignKey('Users.Address', verbose_name='地址', on_delete=models.DO_NOTHING)
...
class OrderGoods(BaseModel):
    ...
    product = models.ForeignKey('Goods.GoodsSKU', verbose_name='商品SKU', on_delete=models.DO_NOTHING)
