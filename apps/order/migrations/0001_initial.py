    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Users.address', verbose_name='地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Goods.goodssku', verbose_name='商品SKU')),
            ],
            options={
                'verbose_name': '商品订单',
